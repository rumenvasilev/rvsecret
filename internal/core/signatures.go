...
type Signature interface {
	Description() string
	Enable() int
	ExtractMatch(file matchfile.MatchFile, sess *Session, change *object.Change) (bool, map[string]int)
	ConfidenceLevel() int
	Part() string
...
func (s SimpleSignature) ExtractMatch(file matchfile.MatchFile, sess *Session, change *object.Change) (bool, map[string]int) {
	var haystack *string
...
func (s PatternSignature) ExtractMatch(file matchfile.MatchFile, sess *Session, change *object.Change) (bool, map[string]int) {
	...
	case PartContent:
		...
		if util.PathExists(*haystack, sess.Out) {
...
func (s SafeFunctionSignature) ExtractMatch(file matchfile.MatchFile, sess *Session, change *object.Change) (bool, map[string]int) {
	var results map[string]int
